...
namespace XS.Core2.FSO
{
	...
	public abstract class FObject
	{
        ...
        ///// <summary>
        /////获取指定目录下指定文件类型的文件列表(绝对路)
        ///// </summary>
        ///// <param name="dirpath">The dirpath绝对路径.</param>
        ///// <param name="Type">指定文件类型，如gif或者png.</param>
        ...
        /// <param name="IsFullPath">是否相对路径</param>
        /// <returns>FileInfo[].</returns>
        public static FileInfo[] GetFileListByType(string dirpath, string Type)
        {
            DirectoryInfo info;
            ...
            //else
            //{
            //    string sPath = XsUtils.GetMapPath(dirpath);
            //    info = new DirectoryInfo(sPath);//HttpContext.Current.Server.MapPath(dirpath)
            //}
            info = new DirectoryInfo(dirpath);
	    ...
	    ///// </summary>
	    ///// <param name="dirpath">The dirpath.</param>
	    ///// <param name="Types">文件类型，new []{"txt","aspx"}.</param>
	    ///// <returns>List&lt;FileInfo&gt;.</returns>
	    //public static List<FileInfo> GetFileListByTypes(string dirpath, string[] Types)
	    //{
	    //  return  GetFileListByTypes(dirpath, Types, false);
